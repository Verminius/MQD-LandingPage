...
window.onload = function () {
  ...
  function init() {
    // Load images
    images = loadImages(["https://i.postimg.cc/qBY9DMn1/sprites1big.png"]);
  ...
  function snapBubble() {
    ...
    const inst9 = document.querySelector("#inst9");

    switch (turncounter) {
      case 1:
        inst1.classList.remove("transicion-inst");
        setTimeout(() => {
          inst2.classList.add("transicion-inst");
        }, 300);
        break;
      case 2:
        inst2.classList.remove("transicion-inst");
        setTimeout(() => {
          inst3.classList.add("transicion-inst");
        }, 300);
        break;
      case 3:
        inst3.classList.remove("transicion-inst");
        setTimeout(() => {
          inst4.classList.add("transicion-inst");
        }, 300);
        break;
      case 4:
        inst4.classList.remove("transicion-inst");
        setTimeout(() => {
          inst5.classList.add("transicion-inst");
        }, 300);
        break;
      case 5:
        inst5.classList.remove("transicion-inst");
        setTimeout(() => {
          inst6.classList.add("transicion-inst");
        }, 300);
        break;
      case 6:
        inst6.classList.remove("transicion-inst");
        setTimeout(() => {
          inst7.classList.add("transicion-inst");
        }, 300);
        break;
      case 7:
        inst7.classList.remove("transicion-inst");
        setTimeout(() => {
          inst8.classList.add("transicion-inst");
        }, 300);
        break;
      ...
      default:
        ...
        setTimeout(() => {
          inst9.classList.add("transicion-inst");
        }, 300);
        break;
    }
  ...
  function render() {
    ...
    var scorex = level.x + level.width - 180;
    ...
    //     context.fillStyle = "rgba(0, 140, 68, 0.8)";
    //     context.fillRect(
    //       level.x - 4,
    //       level.y - 4,
    //       level.width + 8,
  ...
  function drawFrame() {
    ...
    // Draw header
    context.fillStyle = "#009056";
    context.fillRect(0, 0, canvas.width, 79);

    // Draw title
    context.fillStyle = "#ffffff";
    context.fillText("Riesgo Químico", 10, 37);
  ...
  function renderPlayer() {
    ...
    context.fill();
    context.lineWidth = 5;
    context.strokeStyle = "#e8b72f";
    context.stroke();

    // Draw the angle
    context.lineWidth = 2;
    context.strokeStyle = "#ffe16f";
    context.beginPath();
